...
class languages_api:
    def __init__(self, a_model: list[languages_model]):
        self._init_models(a_model)
    
    def _init_models(self, a_model: list[languages_model]):
        self.model = a_model
        self.button_name = []
        self.text_to_button = {}
        ...
        for i in range(len(self.model)):
            ...
            self.text_to_button[i] = str(self.model[i].language)
    
    def load_models(self, new_models: list[languages_model]):
    ...
    def code_to_description(self, code):
